...
utterances[3][3]="bye";
 document.main.src="images/CK15+.002.png";
...
utterances[1][2]="pet--------------";
utterances[2][2]="school/work----------------------------";
utterances[3][2]="TV--------------";
     links[0][3]="i_like";
     links[1][3]="i_dont_like";
     links[2][3]="tell_me_about_you";
utterances[3][3]="--------------";
 document.main.src="images/CK15+.003.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.004.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.005.png";
...
utterances[3][1]="Birthday?";
utterances[0][2]="You live with?--------------";
utterances[1][2]="Any pets?--------------";
utterances[2][2]="school/work----------------------------";
utterances[3][2]="How old?--------------";
utterances[0][3]="What do you like?--------------";
utterances[1][3]="What dont you like?----------------------------";
utterances[2][3]="Do you have?";
utterances[3][3]="--------------";
 document.main.src="images/CK15+.006.png";
...
utterances[2][3]="?   ?well";
utterances[3][3]="cool";
 document.main.src="images/CK15+.007.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.008.png";
...
utterances[2][3]="why";
utterances[3][3]="link";
 document.main.src="images/CK15+.009.png";
...
utterances[3][3]="toiletries";
 document.main.src="images/CK15+.010.png";
...
utterances[2][3]="foot";
 ...
 document.main.src="images/CK15+.011.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.012.png";
...
utterances[3][3]="itch";
 document.main.src="images/CK15+.013.png";
...
utterances[3][0]="No";
     ...
     links[2][3]="nature";
     links[3][3]="link";
 document.main.src="images/CK15+.014.png";
...
utterances[3][3]="charger";
 document.main.src="images/CK15+.015.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.017.png";
...
utterances[3][3]="beans on toast";
 document.main.src="images/CK15+.018.png";
...
utterances[3][3]="rice";
 document.main.src="images/CK15+.019.png";
...
utterances[3][3]="sausages";
 document.main.src="images/CK15+.020.png";
...
utterances[3][3]="hot dog";
 document.main.src="images/CK15+.021.png";
...
utterances[3][3]="lettuce";
 document.main.src="images/CK15+.022.png";
...
utterances[3][2]="hot chocolate";
     ...
     links[3][3]="alcohol";
 document.main.src="images/CK15+.024.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.025.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.026.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.027.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.028.png";
...
utterances[3][3]="chocolate";
 document.main.src="images/CK15+.029.png";
...
utterances[0][2]="link";
utterances[1][2]="mint";
     links[2][2]="glassesfruit";
utterances[3][2]="link";
utterances[0][3]="link";
utterances[1][3]="link";
utterances[2][3]="link";
utterances[3][3]="chocolate";
 document.main.src="images/CK15+.030.png";
...
utterances[0][2]="brickssome";
utterances[1][2]="with";
utterances[2][2]="please";
utterances[3][2]="thank you";
utterances[0][3]="bookhot";
utterances[1][3]="jigsawcold";
utterances[2][3]="dolleat";
utterances[3][3]="drink";
 document.main.src="images/CK15+.031.png";
...
utterances[3][3]="link";
 document.main.src="images/CK15+.032.png";
...
utterances[3][1]="jumper";
     links[0][2]="coloursshape__colour";
...
utterances[3][3]="socks";
 document.main.src="images/CK15+.033.png";
...
utterances[3][3]="couch";
 document.main.src="images/CK15+.034.png";
...
utterances[3][3]="charger";
 document.main.src="images/CK15+.035.png";
...
utterances[3][3]="sanitary items";
 document.main.src="images/CK15+.036.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.037.png";
...
utterances[3][3]="link";
 document.main.src="images/CK15+.038.png";
...
utterances[3][0]="No";
     ...
     links[2][3]="link";
     links[3][3]="link";
 document.main.src="images/CK15+.039.png";
...
utterances[2][3]="wind";
utterances[3][3]="link";
 document.main.src="images/CK15+.040.png";
...
utterances[3][0]="No";
     ...
     links[1][2]="birds";
     links[2][2]="fast_foodinsects";
     links[3][2]="pet_care";
     links[0][3]="unknown";
     links[1][3]="link";
     links[2][3]="link";
     links[3][3]="link";
 document.main.src="images/CK15+.041.png";
...
utterances[2][3]="dog";
utterances[3][3]="link";
 document.main.src="images/CK15+.042.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.043.png";
...
utterances[3][3]="lion";
 document.main.src="images/CK15+.044.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.045.png";
...
utterances[3][3]="link";
 document.main.src="images/CK15+.046.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.047.png";
...
utterances[3][3]="materials";
 document.main.src="images/CK15+.048.png";
...
utterances[3][3]="rake";
 document.main.src="images/CK15+.049.png";
...
utterances[2][3]="see";
 ...
 document.main.src="images/CK15+.050.png";
...
utterances[2][3]="tell";
utterances[3][3]="sing";
 document.main.src="images/CK15+.051.png";
...
utterances[2][3]="boy";
utterances[3][3]="girl";
 document.main.src="images/CK15+.052.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.053.png";
...
utterances[2][3]="link";
     links[3][3]="jobs";
 document.main.src="images/CK15+.054.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.055.png";
...
utterances[2][1]="FriendsDad";
utterances[3][1]="People who helpMum";
utterances[0][2]="link";
utterances[1][2]="link";
utterances[2][2]="brother";
utterances[3][2]="jobssister";
utterances[0][3]="link";
utterances[1][3]="link";
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.056.png";
...
utterances[3][3]="idea";
 document.main.src="images/CK15+.057.png";
...
utterances[3][3]="happy";
 document.main.src="images/CK15+.058.png";
...
utterances[3][3]="blue";
 document.main.src="images/CK15+.059.png";
...
utterances[3][3]="dirty";
 document.main.src="images/CK15+.060.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.061.png";
...
utterances[3][0]="No";
     ...
     links[2][3]="link";
     links[3][3]="link";
 document.main.src="images/CK15+.062.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.063.png";
...
utterances[2][3]="doctors";
 ...
 document.main.src="images/CK15+.064.png";
...
utterances[3][3]="pharmacy";
 document.main.src="images/CK15+.065.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.066.png";
...
utterances[3][3]="stairs";
 document.main.src="images/CK15+.067.png";
...
utterances[3][3]="after";
 document.main.src="images/CK15+.068.png";
...
utterances[0][2]="MMonday";
utterances[1][2]="TTuesday";
utterances[2][2]="WWednesday";
utterances[3][2]="ThThursday";
utterances[0][3]="FFriday";
utterances[1][3]="SSaturday";
utterances[2][3]="SuSunday";
utterances[3][3]="week";
 document.main.src="images/CK15+.069.png";
...
utterances[2][3]="party";
     links[3][3]="christmas";
 document.main.src="images/CK15+.070.png";
...
utterances[2][3]="gift";
utterances[3][3]="link";
 document.main.src="images/CK15+.071.png";
...
utterances[3][0]="No";
     ...
     links[0][3]="computer_control";
     links[1][3]="dvd";
     links[2][3]="tv";
     links[3][3]="ecu";
 document.main.src="images/CK15+.072.png";
...
utterances[3][3]="to go home";
 document.main.src="images/CK15+.073.png";
...
utterances[3][2]="Im not so good";
utterances[0][3]="My storiesChattingTell me your newsTell me your news";
utterances[1][3]="I miss you";
utterances[2][3]="Happy Birthday";
utterances[3][3]="Get well soon";
 document.main.src="images/CK15+.074.png";
...
utterances[3][3]="Fast forward";
 document.main.src="images/CK15+.075.png";
...
utterances[1][3]="peal";
utterances[2][3]="link";
utterances[3][3]="More action wordsdont burn it";
...
utterances[3][3]="under";
 document.main.src="images/CK15+.078.png";
...
utterances[2][3]="link";
utterances[3][3]="link";
 document.main.src="images/CK15+.079.png";
...
utterances[2][3]="doll";
utterances[3][3]="link";
 document.main.src="images/CK15+.080.png";
...
utterances[2][3]="scissors";
     links[3][3]="materials";
 document.main.src="images/CK15+.081.png";
...
utterances[3][3]="link";
 document.main.src="images/CK15+.082.png";
...
utterances[3][3]="link";
 document.main.src="images/CK15+.083.png";
